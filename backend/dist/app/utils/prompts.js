...
exports.generateRAG_USER_MESSAGE = exports.RAG_SYSTEM_PROMPT = exports.MAX_USER_TRIALS = exports.MAX_RETRIES = void 0;
...
`;
function generateRAG_USER_MESSAGE(context, prompt, totalResults, currentPage, resultsInPage) {
    return `
Query: ${prompt}
