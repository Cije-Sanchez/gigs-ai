...
exports.CREATE_FIRST_TIME_USER_MESSAGE = exports.CREATE_FINE_TUNING_USER_MESSAGE = exports.FINE_TUNING_SYSTEM_PROMPT = exports.FIRST_TIME_SYSTEM_PROMPT = void 0;
exports.FIRST_TIME_SYSTEM_PROMPT = `
...
`;
exports.FINE_TUNING_SYSTEM_PROMPT = `
...
function CREATE_FINE_TUNING_USER_MESSAGE(pastQueries, chunks) {
    return `
**Past Queries**:  
${pastQueries
        .map((value, index) => {
...
exports.CREATE_FINE_TUNING_USER_MESSAGE = CREATE_FINE_TUNING_USER_MESSAGE;
function CREATE_FIRST_TIME_USER_MESSAGE(query, chunks) {
    return `
**Query**: ${query}
...
exports.CREATE_FIRST_TIME_USER_MESSAGE = CREATE_FIRST_TIME_USER_MESSAGE;
//# sourceMappingURL=promptsv2.js.map